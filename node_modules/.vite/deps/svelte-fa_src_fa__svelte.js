...
function add_css(target) {
  append_styles(target, "svelte-1cj2gr0", ".spin.svelte-1cj2gr0{animation:svelte-1cj2gr0-spin 2s 0s infinite linear}.pulse.svelte-1cj2gr0{animation:svelte-1cj2gr0-spin 1s infinite steps(8)}@keyframes svelte-1cj2gr0-spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_if_block(ctx) {
  ...
  function select_block_type(ctx2, dirty) {
    if (typeof /*i*/
    ctx2[7][4] == "string") return create_if_block_1;
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(svg, file, 78, 2, 1195);
    },
...
function create_else_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      ctx[7][0] / -2} ${/*i*/
      ctx[7][1] / -2})`);
      add_location(path0, file, 99, 10, 1721);
      ...
      ctx[7][0] / -2} ${/*i*/
      ctx[7][1] / -2})`);
      add_location(path1, file, 105, 10, 1982);
    },
    m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      ctx[7][0] / -2} ${/*i*/
      ctx[7][1] / -2})`);
      add_location(path, file, 93, 10, 1533);
    },
    m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("class" in $$props2) $$invalidate(11, clazz = $$props2.class);
    if ("id" in $$props2) $$invalidate(0, id = $$props2.id);
    if ("style" in $$props2) $$invalidate(12, style = $$props2.style);
    if ("icon" in $$props2) $$invalidate(13, icon = $$props2.icon);
    if ("size" in $$props2) $$invalidate(14, size = $$props2.size);
    if ("color" in $$props2) $$invalidate(1, color = $$props2.color);
    if ("fw" in $$props2) $$invalidate(15, fw = $$props2.fw);
    if ("pull" in $$props2) $$invalidate(16, pull = $$props2.pull);
    if ("scale" in $$props2) $$invalidate(17, scale = $$props2.scale);
    if ("translateX" in $$props2) $$invalidate(18, translateX = $$props2.translateX);
    if ("translateY" in $$props2) $$invalidate(19, translateY = $$props2.translateY);
    if ("rotate" in $$props2) $$invalidate(20, rotate = $$props2.rotate);
    if ("flip" in $$props2) $$invalidate(21, flip = $$props2.flip);
    if ("spin" in $$props2) $$invalidate(22, spin = $$props2.spin);
    if ("pulse" in $$props2) $$invalidate(23, pulse = $$props2.pulse);
    if ("primaryColor" in $$props2) $$invalidate(2, primaryColor = $$props2.primaryColor);
    if ("secondaryColor" in $$props2) $$invalidate(3, secondaryColor = $$props2.secondaryColor);
    if ("primaryOpacity" in $$props2) $$invalidate(4, primaryOpacity = $$props2.primaryOpacity);
    if ("secondaryOpacity" in $$props2) $$invalidate(5, secondaryOpacity = $$props2.secondaryOpacity);
    if ("swapOpacity" in $$props2) $$invalidate(6, swapOpacity = $$props2.swapOpacity);
  };
  $$self.$capture_state = () => ({
    joinCss,
    getStyles,
  ...
  $$self.$inject_state = ($$props2) => {
    if ("clazz" in $$props2) $$invalidate(11, clazz = $$props2.clazz);
    if ("id" in $$props2) $$invalidate(0, id = $$props2.id);
    if ("style" in $$props2) $$invalidate(12, style = $$props2.style);
    if ("icon" in $$props2) $$invalidate(13, icon = $$props2.icon);
    if ("size" in $$props2) $$invalidate(14, size = $$props2.size);
    ...
    if ("secondaryOpacity" in $$props2) $$invalidate(5, secondaryOpacity = $$props2.secondaryOpacity);
    if ("swapOpacity" in $$props2) $$invalidate(6, swapOpacity = $$props2.swapOpacity);
    if ("i" in $$props2) $$invalidate(7, i = $$props2.i);
    if ("c" in $$props2) $$invalidate(8, c = $$props2.c);
    if ("s" in $$props2) $$invalidate(9, s = $$props2.s);
    if ("transform" in $$props2) $$invalidate(10, transform = $$props2.transform);
  };
